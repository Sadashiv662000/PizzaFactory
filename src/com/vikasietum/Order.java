...
public class Order{
	...
	public static void main(String[] args) {
		...
		System.out.println("welcome to vikasietum PizzaFactory");
		System.out.println("**********************************");
	...
	private static int selectTopings() {
		...
		public static int vegtoppings(String type)
		{
			...
			{
				sum = sum + val;
			System.out.println("enter 1:black olive"); 
			System.out.println("enter 2:capsicum");
			System.out.println("enter 3:paneer");
			System.out.println("enter 4:mushroom");
			System.out.println("enter 5:fresh tomato");
			System.out.println("enter 6:extra cheese");
